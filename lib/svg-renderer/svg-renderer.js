...
function renderSvgString(imageData, svgSettings, width, height, done) {
  ...
  (0, _setImmediate3.default)(function () {
    ...
    switch (svgSettings.svgRenderType) {
      case _Controller.SVG_RENDER_TYPES.CIRCLE:
        {
      ...
      case _Controller.SVG_RENDER_TYPES.CURVE:
        {
      ...
      case _Controller.SVG_RENDER_TYPES.LINE:
        {
      ...
      case _Controller.SVG_RENDER_TYPES.RECURSIVE:
        {
