...
function renderCircles(svgSettings, circles) {
  ...
  for (i = 0; i < circles.length; i++) {
    ...
    renderString += '<circle cx="' + x * outputScale + '" cy="' + y * outputScale + '" r="' + r * outputScale + '" style="stroke: ' + (stroke ? strokeColor : 'none') + '; stroke-width: ' + strokeWidth + '; fill: ' + (fill ? fillColor : 'none') + ';" />';
  }
