...
var ImageRenderer = function (_Component) {
  ...
  function ImageRenderer(props) {
    ...
    _this.onConfigChange = function (functionToCall, optionalArgument) {
      functionToCall(optionalArgument);

      _this.setState({
        currentConfigName: _this.controller.config.getCurrentConfigName(),
        configNames: _this.controller.config.getConfigNames()
      });
  ...
  (0, _createClass3.default)(ImageRenderer, [{
    ...
    value: function updateSvgRender() {
      ...
      if (this.state.isRendered && this.imageData && this.props.controller.config['Live Update']) {
        (0, _svgRenderer.renderSvgString)(this.imageData.data, this.props.controller.config, this.width, this.height, function (svgString) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ControlBar2.default, {
          ...
          onConfigChange: function onConfigChange(newConfigName) {
            return _this5.onConfigChange(_this5.props.controller.config.loadConfig, newConfigName);
          },
          ...
          onRevertClicked: function onRevertClicked() {
            return _this5.onConfigChange(_this5.props.controller.config.revertCurrentConfig);
          },
          onLoadConfigClicked: function onLoadConfigClicked() {
            return _this5.onConfigChange(_this5.props.controller.config.loadConfigFromJson);
          },
          onCreateNewConfigClicked: function onCreateNewConfigClicked() {
            return _this5.onConfigChange(_this5.props.controller.config.createNewConfig);
          },
          onDeleteConfigClicked: function onDeleteConfigClicked() {
            return _this5.onConfigChange(_this5.props.controller.config.deleteConfig);
          },
          onSaveConfigClicked: function onSaveConfigClicked() {
            return _this5.onConfigChange(_this5.props.controller.config.saveConfigs);
          }
        }),
