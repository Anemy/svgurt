      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ControlBar2.default, {
          ...
          onConfigChange: function onConfigChange(newConfigName) {
            _this5.props.controller.config.loadConfig(newConfigName);_this5.onConfigChange();
          },
          ...
          onRevertClicked: function onRevertClicked() {
            _this5.props.controller.config.revertCurrentConfig();_this5.onConfigChange();
          },
          onLoadConfigClicked: function onLoadConfigClicked() {
            _this5.props.controller.config.loadConfigFromJson();_this5.onConfigChange();
          },
          onCreateNewConfigClicked: function onCreateNewConfigClicked() {
            _this5.props.controller.config.createNewConfig();_this5.onConfigChange();
          },
          onDeleteConfigClicked: function onDeleteConfigClicked() {
            _this5.props.controller.config.deleteConfig();_this5.onConfigChange();
          },
          onSaveConfigClicked: function onSaveConfigClicked() {
            _this5.props.controller.config.saveConfigs();_this5.onConfigChange();
          }
        }),
